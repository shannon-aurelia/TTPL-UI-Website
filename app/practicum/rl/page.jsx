...
export default function Page() {
  return <section className="section module-layout">
    <aside className="sidebar liquid">
      ...
      <br/>
      <a className="side-link" href="/modules/modul-rangkaian-listrik-2025-2026.pdf" target="_blank">PDF Module</a>
    ...
    <div>
      ...
      <div className="module-grid">{modules.map((module, index) => <div className="module-card" key={module}>
        ...
        <h3>{module}</h3>
        <p>{index === 0 ? 'Offline pre-test. Review the module and wait for the schedule imported from the practicum sheet.' : 'Open the module and official TTPL video before the practicum session.'}</p>
        <a className="chip" href="/modules/modul-rangkaian-listrik-2025-2026.pdf" target="_blank">PDF</a>
