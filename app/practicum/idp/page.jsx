    ...
    <section className="section module-layout">
      <aside className="sidebar liquid">
        ...
        <Link className="side-link" href={readerHref(1, modules[0])}>
          Tracked Pre-test Module
        </Link>
        <Link className="side-link" href={readerHref(2, modules[1])}>
          Tracked Modules 2–8
        </Link>
        <a
          className="side-link"
      ...
      <div>
        ...
        <p className="subtitle">
          Module 1 is a pre-test schedule placeholder. Modules 2&3 and 4&5 are
          grouped, while Modules 6, 7, and 8 are individual. Report files are
          submitted through EMAS3.
        </p>
        <div className="module-grid">
          {modules.map((module, index) => (
            <div className="module-card" key={module}>
              ...
              <p>
                {index === 0
                  ? "Pre-test resources and schedule. No report upload is enabled here."
                  : "Review the instrument, measurement procedure, and related TTPL video before lab."}
              </p>
