export const REPORT_GROUPS = {
  rl: [
    ...
    { id: 'rl-2-3', modules: [2, 3], title: 'Modules 2–3 Combined Report', submission: true },
    { id: 'rl-4-5', modules: [4, 5], title: 'Modules 4–5 Combined Report', submission: true },
  ...
  idp: [
    ...
    { id: 'idp-2', modules: [2], title: 'Module 2 Report', submission: true },
    { id: 'idp-3', modules: [3], title: 'Module 3 Report', submission: true },
    { id: 'idp-4', modules: [4], title: 'Module 4 Report', submission: true },
    { id: 'idp-5', modules: [5], title: 'Module 5 Report', submission: true },
  ...
  t3: [
    { id: 't3-1', modules: [1], title: 'Module 1 Report', submission: true },
    { id: 't3-2', modules: [2], title: 'Module 2 Report', submission: true },
    { id: 't3-3', modules: [3], title: 'Module 3 Report', submission: true },
    { id: 't3-4', modules: [4], title: 'Module 4 Report', submission: true },
    { id: 't3-5', modules: [5], title: 'Module 5 Report', submission: true },
    { id: 't3-6', modules: [6], title: 'Module 6 Report', submission: true },
    { id: 't3-7', modules: [7], title: 'Module 7 Report', submission: true },
